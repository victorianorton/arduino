/* 
  ...
  First 30 pulses will simulatenously turn on LED light, and solenoid (trigger stimulus) - for one second.
  Next 15 pulses (16-30) will simulatenously turn on camera, LED light, and solenoid - for one second. 
